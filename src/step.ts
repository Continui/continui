...
export interface Step<Context> {
  ...
  options: StepOption[];
     ...
     */
  createsRestaurationPoint(stepOptionValueMap: StepOptionValueMap,
     ...
     * @param context Represents the step execution context.
     */
  execute(stepOptionValueMap: StepOptionValueMap,
          context: Context): void | Promise<void> | IterableIterator<any>;
     ...
     * @param context Represents the step execution context.
     */
  restore(stepOptionValueMap: StepOptionValueMap,
          context: Context): void | Promise<void> | IterableIterator<any>;    
